...
# This function loads your pre-trained vectorizer and model.
...
def load_artifacts():
    ...
    try:
        # Update filenames to match your notebook
        ...
        st.error("Model or vectorizer files not found. Please make sure 'BoW.pickle' and 'model.pickle' are in the same directory as the script.")
        return None, None
...
def main():
    ...
    st.markdown("""
    This app uses your pre-trained **Bag-of-Words** model and **Multinomial Naive Bayes** classifier to predict whether a message is spam. 
    ...
    message_input = st.text_area(
        ...
        "Congratulations! You've won a free ticket. Text 'WIN' to claim.",
        height=150
    )
